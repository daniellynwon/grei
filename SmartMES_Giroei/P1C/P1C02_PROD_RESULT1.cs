...
{
    public partial class P1C02_PROD_RESULT1 : SmartMES_Giroei.FormBasic
    {
        int rowIndex = 0;
        ...
        public void ListSearch()
        {
            ...
            try
            {
                ...
                string sLine = cbWorkLine.SelectedValue == null ? "0001" : cbWorkLine.SelectedValue.ToString();     //string s = cbWorkLine.SelectedValue.ToString();

                sP_ProdResult_Query1TableAdapter.Fill(dataSetP1C.SP_ProdResult_Query1, sLine, DateTime.Parse(sDate));
        ...
        public void ListSearch1(string sLine)
        {
            ...
            if (cbWorkLine.Items.Count == 0) return;
            ...
            try
            {
                ...
                tbJobNo.Text = dataGridView1.Rows[rowIndex].Cells[1].Value == DBNull.Value ? null : dataGridView1.Rows[rowIndex].Cells[1].Value.ToString();
                tbProd.Tag = dataGridView1.Rows[rowIndex].Cells[3].Value == DBNull.Value ? null : dataGridView1.Rows[rowIndex].Cells[3].Value.ToString();
                tbProd.Text = dataGridView1.Rows[rowIndex].Cells[4].Value == DBNull.Value ? null : dataGridView1.Rows[rowIndex].Cells[4].Value.ToString();
                dtpStartTime.Text = dataGridView1.Rows[rowIndex].Cells[5].Value == DBNull.Value ? null : DateTime.Parse(dataGridView1.Rows[rowIndex].Cells[5].Value.ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                dtpDoneTime.Text = dataGridView1.Rows[rowIndex].Cells[6].Value == DBNull.Value ? null : DateTime.Parse(dataGridView1.Rows[rowIndex].Cells[6].Value.ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                tbQty.Text = dataGridView1.Rows[rowIndex].Cells[8].Value == DBNull.Value ? null : dataGridView1.Rows[rowIndex].Cells[8].Value.ToString();
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    return;
                //}
                //string reportFileName = "SmartMES_Giroei.Reports.P1C02_PROD_RESULT1.rdlc";
