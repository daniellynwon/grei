    ...
    public partial class P1B10_PURCHASE_MAT_SUB : Form
    {
        ...
        private void P1B10_PURCHASE_MAT_SUB_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                tbSize.Text = parentWin.dataGridView1.Rows[rowIndex].Cells[17].Value.ToString();
                tbQty.Text = parentWin.dataGridView1.Rows[rowIndex].Cells[6].Value.ToString();
                tbDanga.Text = parentWin.dataGridView1.Rows[rowIndex].Cells[7].Value.ToString();
                tbMoney.Text = (long.Parse(parentWin.dataGridView1.Rows[rowIndex].Cells[6].Value.ToString()) * long.Parse(parentWin.dataGridView1.Rows[rowIndex].Cells[7].Value.ToString())).ToString("#,##0");
