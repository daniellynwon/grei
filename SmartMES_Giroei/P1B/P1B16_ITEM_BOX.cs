...
{
    public partial class P1B16_ITEM_BOX : SmartMES_Giroei.FormBasic
    {
        public P1B16_ITEM_BOX()
        {
            InitializeComponent();
        }
        private void P1B16_ITEM_BOX_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //string sIsComplete = string.Empty;
            //string sBoxID = string.Empty;

            //if (e.ColumnIndex != 7)
            //{
            //    sSujuNo = dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
            //    sSujuSeq = dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString();
            //    sProdID = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();
            //    sProdName = dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString();
            //    sBoxID = dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString();

            //    P1B16_ITEM_BOX_SUB sub = new P1B16_ITEM_BOX_SUB();
            //    sub.sGubun = "자재입고";
            //    sub.sSujuNo = sSujuNo;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == 7)
            {
                ...
                sProdID = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();
                sProdName = dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString();
                sIsComplete = dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString();
        ...
        {
            //string reportFileName = "SmartMES_Giroei.Reports.P1B16_ITEM_BOX.rdlc";
