...
{
    public partial class P1B15_PURCHASE_MAT_OUT : SmartMES_Giroei.FormBasic
    {
        public P1B15_PURCHASE_MAT_OUT()
        {
            InitializeComponent();
        }
        private void P1B15_PURCHASE_MAT_OUT_Load(object sender, EventArgs e)
        {
        ...
        public void ListSearch()
        {
            try
            {
                ...
                sP_PurchaseRawMat_OUTTableAdapter.Fill(dataSetP1B.SP_PurchaseRawMat_OUT, dtFromDate, dtToDate, sSearch);
            ...
            try
            {
                ...
                for (int i = 0; i < rowIndex; i++)
                {
                    ...
                    if (!(string.IsNullOrEmpty(dataGridView1.Rows[i].Cells[10].Value.ToString())))
                        iSum1 += long.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString());
                    else iSum1 += 0;
                    ...
                    if (!(string.IsNullOrEmpty(dataGridView1.Rows[i].Cells[12].Value.ToString())))
                        iSum3 += long.Parse(dataGridView1.Rows[i].Cells[12].Value.ToString());
                    else iSum3 += 0;

                    if (!(string.IsNullOrEmpty(dataGridView1.Rows[i].Cells[13].Value.ToString())))
                        iSum4 += long.Parse(dataGridView1.Rows[i].Cells[13].Value.ToString());
                    else iSum4 += 0;
                }

                dataGridView1[0, rowIndex].Value = iSujuCount.ToString() + "건";

                dataGridView1[10, rowIndex].Value = iSum1;
                dataGridView1[11, rowIndex].Value = iSum2;
                dataGridView1[12, rowIndex].Value = iSum3;
                dataGridView1[13, rowIndex].Value = iSum4;
            }
            catch (NullReferenceException)
            {
                return;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //if (e.ColumnIndex == 5)
            //{
            //    //P1B15_PURCHASE_MAT_OUT_SUB sub = new P1B15_PURCHASE_MAT_OUT_SUB();
            ...
            //{
            //    //P1B15_PURCHASE_MAT_OUT_IN sub = new P1B15_PURCHASE_MAT_OUT_IN();
        ...
        {
            string reportFileName = "SmartMES_Giroei.Reports.P1B15_PURCHASE_MAT_OUT.rdlc";

            string reportParm1 = "작업지시일자 : ";
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", sPPurchaseRawMatOUTBindingSource);
