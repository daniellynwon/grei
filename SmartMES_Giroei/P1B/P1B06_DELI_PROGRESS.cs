...
{
    public partial class P1B06_DELI_PROGRESS : SmartMES_Giroei.FormBasic
    {
        public P1B06_DELI_PROGRESS()
        {
            InitializeComponent();
        }
        private void P1B06_DELI_PROGRESS_Load(object sender, EventArgs e)
        {
        ...
        public void ListSearch()
        {
            try
            {
                ...
                sP_Progress_QueryTableAdapter.Fill(dataSetP1B.SP_Progress_Query, dtFromDate, dtToDate, sSearch);
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Giroei.Reports.P1B06_DELI_PROGRESS.rdlc";
        ...
        private void P1B06_DELI_PROGRESS_Activated(object sender, EventArgs e)
        {
            ListSearch();
        }
    }
