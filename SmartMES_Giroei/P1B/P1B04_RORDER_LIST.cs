...
namespace SmartMES_Giroei
{
    public partial class P1B04_RORDER_LIST : SmartMES_Giroei.FormBasic
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //else if (e.ColumnIndex == 9) // 이전 상세합계금액의 칼럼번호
            //{
            //    DataTable table;
            ...
            //        {
            //            sText = sText + "제작 : " + string.Format("{0:#,0}", int.Parse(table.Rows[i][1].ToString())) + "원";
            //        }
            ...
            //        else
            //        {
            //            sText = sText + "기타(METAL) : " + string.Format("{0:#,0}", int.Parse(table.Rows[i][1].ToString())) + "원";
            //        }
            //        sText = sText + "\n\r";
            //    }
