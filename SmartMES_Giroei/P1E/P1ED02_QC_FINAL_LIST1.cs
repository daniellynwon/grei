...
{
    public partial class P1ED02_QC_FINAL_LIST1 : SmartMES_Giroei.FormBasic
    {
        public P1ED02_QC_FINAL_LIST1()
        {
            InitializeComponent();
        }
        private void P1ED02_QC_FINAL_LIST1_Load(object sender, EventArgs e)
        {
            dtpFromDate.Value = Convert.ToDateTime(DateTime.Today.ToString("yyyy-01-01"));
            this.ActiveControl = tbSearch;

            chartA.Series[0].Name = "M . I";
            chartA.Series[1].Name = "연신율";
            chartA.Series[2].Name = "강도";
        }
        public void ListSearch()
        {
            try
            {
                ...
                sP_QcFinalList_ListTableAdapter.Fill(dataSetP1E.SP_QcFinalList_List, dtFromDate, dtToDate, sSearch);
                chartA.DataSource = sPQcFinalListListBindingSource;

                chartA.Series[0].XValueMember = "번호";
                chartA.Series[0].YValueMembers = "결과1";
                chartA.Series[1].XValueMember = "번호";
                chartA.Series[1].YValueMembers = "결과2";
                chartA.Series[2].XValueMember = "번호";
                chartA.Series[2].YValueMembers = "결과3";
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Giroei.Reports.P1ED02_QC_FINAL_LIST1.rdlc";

            string reportParm1 = "검사기간 : ";
            string reportParm2 = "검사자 : ";
            string reportParm3 = "";
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", sPQcFinalListListBindingSource);
